...
public class IDORViewOwnProfileAltUrl implements AssignmentEndpoint {
  ...
  public AttackResult completed(@RequestParam String url) {
    ...
    // Resolve the object from the authenticated session. Treating a client-submitted path as an
    // object reference would disclose whether guessed identifiers exist.
